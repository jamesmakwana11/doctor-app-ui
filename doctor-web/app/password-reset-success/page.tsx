      ...
      <div className="w-[1200px] h-[640px] bg-white rounded-2xl shadow-xl flex overflow-hidden">
        ...
        <div className="w-1/2 px-20 py-16 flex flex-col justify-center">
          ...
          <p className="text-gray-600 mb-8">
            We’ve sent the password to <br />
            <span className="font-medium">**221b@gmail.com</span>. Resend if the
            password is not received! 🔥
          </p>

          <button className="bg-[#5F3BFE] text-white py-3 rounded-md text-lg w-64">
            Go to home →
          </button>
